...
def add_tareas():
    ...
    if numsol1 == "" or idtec == "" or usuario == "" or direccion == "" or detalle == "" or observ == "":
        ...
        if request.method == 'POST':
            ...
            cur.execute("INSERT INTO asignacion_tarea (at_numsolicitud, at_idtecnico, at_zona, at_tipo, at_usuario, at_direccion, at_detalle, at_horario, at_observ_orden, at_estado, at_fecha) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (numsol,idtec,zona,tipo,usuario,direccion,detalle,horario,observ,'Pendiente','27/02/2022'))
            conn.commit()
            cur.close()
    ...
    if id == "" or nombres == "" or apellidos == "" or telefono == "" or direccion == "":
        ...
        if data:
            ...
            if request.method == 'POST':
                ...
                cur.execute("INSERT INTO tecnicos (te_identificacion, te_nombres, te_apellidos, te_telefono, te_direccion, te_nivel) VALUES (%s,%s,%s,%s,%s,%s)", (id, nombres, apellidos, telefono, direccion, nivel))
                conn.commit()
                cur.close()
